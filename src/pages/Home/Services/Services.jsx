...
const Services = () => {
    ...
    useEffect(() => {
        fetch(`https://car-doctor-server-woad-ten.vercel.app/services?search=${search}&sort=${asc ? 'asc' : 'desc'}`)
            .then(res => res.json())
                ...
                <div className="flex justify-between items-center w-11/12 mx-auto my-4">
                    <div className="form-control">
                        <div className="input-group">
                            ...
                            <button onClick={handleSearch} className="btn btn-square btn-accent">
